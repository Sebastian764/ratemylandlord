        ...
        <nav className="flex items-center gap-3 md:gap-6">
          {user ? (
            ...
            <>
              ...
              <Link
                to="/register"
                className="px-4 py-2 text-sm font-medium text-white bg-primary-600 rounded-lg hover:bg-primary-700 transition-all shadow-sm hover:shadow hover:-translate-y-0.5"
              >
                Sign Up
              </Link>
            </>
