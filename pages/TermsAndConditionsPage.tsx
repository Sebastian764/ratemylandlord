...
const TermsAndConditionsPage: React.FC = () => {
  return (
    <div className="max-w-3xl mx-auto p-6 bg-white rounded-lg shadow-md">
      <h1 className="text-3xl font-bold mb-6 text-primary-900">Terms &amp; Conditions</h1>

      <section className="mb-8 text-gray-700 space-y-3">
        <h2 className="text-2xl font-semibold text-primary-800">1. Introduction &amp; Acceptance</h2>
      ...
      <section className="mb-8 text-gray-700 space-y-3">
        <h2 className="text-2xl font-semibold text-primary-800">2. User Accounts &amp; Content</h2>
      ...
      <section className="mb-8 text-gray-700 space-y-3">
        <h2 className="text-2xl font-semibold text-primary-800">3. Content Guidelines</h2>
      ...
      <section className="mb-8 text-gray-700 space-y-3">
        <h2 className="text-2xl font-semibold text-primary-800">4. Privacy &amp; Data Use</h2>
      ...
      <section className="mb-8 text-gray-700 space-y-3">
        <h2 className="text-2xl font-semibold text-primary-800">5. Disclaimer &amp; Liability Limits</h2>
      ...
      <section className="mb-8 text-gray-700 space-y-3">
        <h2 className="text-2xl font-semibold text-primary-800">6. Dispute Resolution Policy</h2>
        ...
        <p><strong>6.2 Filing a Dispute.</strong> If you believe a review violates the above listed Guidelines, you may dispute it by emailing us at <a href="mailto:pittratemylandlord@gmail.com" className="text-primary-600 hover:underline">pittratemylandlord@gmail.com</a> with specific details and any relevant context.</p>
      ...
      <section className="mb-8 text-gray-700 space-y-3">
        <h2 className="text-2xl font-semibold text-primary-800">7. Termination &amp; Suspension</h2>
      ...
      <section className="mb-8 text-gray-700 space-y-3">
        <h2 className="text-2xl font-semibold text-primary-800">8. Governing Law &amp; Legal</h2>
      ...
      <section className="mb-8 text-gray-700 space-y-3">
        <h2 className="text-2xl font-semibold text-primary-800">9. Verification Process</h2>
      ...
      <section className="text-gray-700 space-y-3">
        <h2 className="text-2xl font-semibold text-primary-800">10. Contact &amp; Updates</h2>
        <p><strong>10.1 Contact.</strong> Questions about these Terms should be directed to <a href="mailto:pittratemylandlord@gmail.com" className="text-primary-600 hover:underline">pittratemylandlord@gmail.com</a>.</p>
